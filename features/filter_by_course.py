...
from data_manager import load_data  # Assure-toi que tu as un fichier data_manager.py qui charge les projets
...
def get_projects_by_course(course_name: str):
    ...
    """
    data = load_data()  # Charge les projets depuis data_manager
    filtered_projects = [
